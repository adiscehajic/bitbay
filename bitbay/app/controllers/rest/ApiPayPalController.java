...
import views.html.purchase.androidPurchaseResult;
import views.html.purchase.androidShowUserPurchases;
...
//            redirects.setReturnUrl("http://localhost:9000/api/purchasesuccess");
    ...
    public Result purchaseSuccess() {
        ...
        /**when the payment is built, the client is redirected to the
         purchaseResult view*/
        return ok(androidPurchaseResult.render());
    }

    public Result purchaseFail() {

        return ok(androidShowUserPurchases.render());
    }
}
