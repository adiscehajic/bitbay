...
public class Global extends GlobalSettings {
    ...
    public void onStart(Application application) {
        ...
        if (Ebean.find(UserType.class).findRowCount() == 0) {
            ...
            Product p51 = new Product(userOne, "Humans of New York: Stories", "â€œThere's no judgment, just observation and in many cases reverence, making for an inspiring reading and visual experience.â€? ", "St. Martin's Press", categoryFour, 20.00, 10, "1");
